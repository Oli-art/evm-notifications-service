  ...
  async execute (interaction) {
    ...
    const exampleEmbed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '\u200B', value: ' ' },
        { name: 'Set up your addresses', value: 'You can set up what addresses are yours with `/set_address` so you get notified when you get a DM. You can see your addresses using `/see_my_addresses` and you can unset them using `/unset_address`.'},
        { name: '\u200B', value: ' ' },
